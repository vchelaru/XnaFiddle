...
namespace XnaFiddle
{
    ...
    public static class ExampleGallery
    {
        ...
        [
            ...
            new ExampleInfo { Name = "Bloom",           Category = "2D Shaders", Description = "Classic bloom post-process: extract bright areas, blur them, and combine the glow back over the scene (intensity & saturation knobs)" },
            ...
            new ExampleInfo { Name = "GumUI",                        Category = "Gum",                Description = "UI layout with buttons and text using Gum — click a chip to switch Gum.Themes.* visual themes" },
            ...
            new ExampleInfo { Name = "SkiaGameRendering",            Category = "SkiaGameRendering",  Description = "Draw shapes with the SkiaGameRendering library" },
        ];
