...
public class Game1 : Game
{
    ...
    protected override void LoadContent()
    {
        ...
        // Saturate.fx (a bloom pass) is compiled to an Effect in-browser when you press Run.
        effect = Content.Load<Effect>("Saturate");
        // Bloom parameters, passed from C#. Try tweaking the intensity.
        effect.Parameters["BloomThreshold"]?.SetValue(new Vector4(0.25f, 0.25f, 0.25f, 0.25f));
        effect.Parameters["BloomIntensity"]?.SetValue(1.5f);
