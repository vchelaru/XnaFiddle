...
public class Game1 : Game
{
    ...
    protected override void LoadContent()
    {
        ...
        // Sepia.fx is compiled to an Effect in-browser when you press Run.
        effect = Content.Load<Effect>("Sepia");
        // Shader parameters are set from C#. (HLSL initializers aren't baked into the
        // compiled bytes, so set them here to make the effect visible.)
